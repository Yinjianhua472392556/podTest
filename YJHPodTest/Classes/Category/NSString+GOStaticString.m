...
#import "NSString+GOStaticString.h"
#import "CommonCrypto/CommonDigest.h"
#import<CommonCrypto/CommonCryptor.h>
#import <CoreText/CoreText.h>

@implementation NSString (GOStaticString)
...
BOOL GOValidatePIN(NSString *identification){
    ...
    //年份
    int strYear = GOGetSubStringWithRange(carid, NSMakeRange(6, 4)).intValue;
    
    //月份
    
    int strMonth = GOGetSubStringWithRange(carid, NSMakeRange(10, 2)).intValue;
    
    //日
    
    int strDay = GOGetSubStringWithRange(carid, NSMakeRange(12, 2)).intValue;
...
+ (NSString *) GOValidateMobileThreeNumber:(NSString *)mobileNum
{
    ...
    NSString *MOBILE = @"^1(3[0-9]|4[579]|5[0-35-9]|7[0135-8]|8[0-9])\\d{0}$";
    

    if ([mobileNum isEqualToString:@"170"]) {
        return @"虚拟号";
    }else{
