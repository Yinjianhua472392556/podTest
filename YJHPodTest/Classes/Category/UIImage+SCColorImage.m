...
#import "UIImage+SCColorImage.h"
#import <UIKit/UIKit.h>
#import <AVFoundation/AVFoundation.h>
#import "UIImage+SCColorImage.h"


@implementation UIImage (SCColorImage)
...
+ (UIImage *)createQRImageWithString:(NSString *)qrString size:(CGFloat)size {
    ...
    //NSString *string = [NSString stringWithFormat:@"http://www.gmall88.com/g/index.html?appid=999929403&scardpage=1&shareagentid=%@",[SCUserManager sharedManager].user.ID];
    ...
    CFRelease(cs);
    //水印图
    CGFloat waterImagesize = 100;
    UIImage *waterimage = [UIImage imageNamed:@"AppIcon"];
