...
TODO: Add long description of the pod here.llalalalalalla
  ...
  s.source           = { :git => 'https://github.com/Yinjianhua472392556/podTest.git', :tag => "0.1.2" }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = "Classes", "YJHPodTest/Classes/**/*.{h,m}"
  
  # s.resource_bundles = {
  #   'YJHPodTest' => ['YJHPodTest/Assets/*.png']
  # }

  s.public_header_files = 'YJHPodTest/Classes/**/*.h'
